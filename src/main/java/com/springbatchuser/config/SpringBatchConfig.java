...
import com.springbatchuser.batch.SqlFileWriterManual;
...
public class SpringBatchConfig {
	...
	@Autowired
	private SqlFileWriterManual sqfm;
	...
	public Step step2() {
		return stepBuilderFactory.get("step2").<String, String>chunk(3)
				.reader(multiResourceItemReaderSql3())
				.writer(sqlWritter).build();
	}
	
	@Bean
	public Step step3() {
		return stepBuilderFactory.get("step3").<String, String>chunk(3)
				.reader(multiResourceItemReaderSql4())
				.writer(sqlWritter).build();
	}
